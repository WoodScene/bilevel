...
def main(args):
    ...
    avgPerf_list = []
    acc_task_num = 0
    print("Calculating score for each task.....")
    for service_id in range(1, len(dataset_order)):
        ...
        avgPerf_list.append(joint_accuracy)
        #break    
...
if __name__=='__main__':
    ...
    for data_id in range(1):
        ...
        #parser.add_argument("--test_data_name", type=str, default="t5largelora1_dataset_id_6_fwt", help = "_with_memoryreplay")
        #parser.add_argument("--test_data_name", type=str, default="t5largelora10_TaSL_dataset_id_6_fwt", help = "_with_memoryreplay")
        #parser.add_argument("--test_data_name", type=str, default="t5largelora7_TaSL_dataset_id_1_fwt", help = "-averaging")
        
        parser.add_argument("--test_data_name", type=str, default="TaSL1_dataset_id_3_fwt", help = "-averaging")
